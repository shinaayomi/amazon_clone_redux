          ...
          <div className="md:col-span-2 flex flex-col gap-3 justify-center p-4">
            ...
            <div>
              ...
              <button
                ...
                className="w-ful md:w-96 h-12 bg-amazon_blue text-gray-200 hover:bg-amazon_yellow hover:text-amazon_blue duration-300 rounded-lg mt-5 text-base font-semibold"
              >
                Add to cart
              </button>
            </div>
